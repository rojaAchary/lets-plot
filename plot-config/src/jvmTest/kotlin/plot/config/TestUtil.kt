...
object TestUtil {
    ...
    private fun createGeomLayers(plotOpts: MutableMap<String, Any>): List<GeomLayer> {
        val transformed = PlotConfigServerSide.processTransform(plotOpts)
    ...
    internal fun getSingleGeomLayer(plotOpts: MutableMap<String, Any>): GeomLayer {
        val geomLayers = createGeomLayers(plotOpts)
